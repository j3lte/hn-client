...
import { HNSearchClient, type HNSearchClientOptions } from "./algolia/mod.ts";
...
export class HackerNewsClient {
  ...
  frontPage(params: Omit<SearchParams, "tags" | "sortByDate" | "hitsPerPage">, init: RequestInit = {}) {
  ...
  newest(params: Omit<SearchParams, "tags" | "sortByDate">, init: RequestInit = {}) {
    return this.searchClient.search({
      ...params,
  ...
  comments(params: Omit<SearchParams, "tags" | "sortByDate">, init: RequestInit = {}) {
    return this.searchClient.search({
      ...params,
      tags: [Tags.COMMENT],
    }, init);
  ...
  askHN(params: Omit<SearchParams, "tags" | "sortByDate">, init: RequestInit = {}) {
    return this.searchClient.search({
      ...params,
      tags: [Tags.ASK_HN],
    }, init);
  ...
  showHN(params: Omit<SearchParams, "tags" | "sortByDate">, init: RequestInit = {}) {
    return this.searchClient.search({
      ...params,
      tags: [Tags.SHOW_HN],
    }, init);
  ...
  polls(params: Omit<SearchParams, "tags" | "sortByDate">, init: RequestInit = {}) {
    return this.searchClient.search({
      ...params,
      tags: [Tags.POLL],
    }, init);
  ...
  jobs(params: Omit<SearchParams, "tags" | "sortByDate">, init: RequestInit = {}) {
    return this.searchClient.search({
      ...params,
      tags: [Tags.JOB],
    }, init);
  ...
  userAll(userName: string, params: Omit<SearchParams, "tags" | "sortByDate">, init: RequestInit = {}) {
    return this.searchClient.search({
      ...params,
  ...
  userThreads(userName: string, params: Omit<SearchParams, "tags" | "sortByDate">, init: RequestInit = {}) {
    return this.searchClient.search({
      ...params,
  ...
  userSubmitted(userName: string, params: Omit<SearchParams, "tags" | "sortByDate">, init: RequestInit = {}) {
    return this.searchClient.search({
      ...params,
